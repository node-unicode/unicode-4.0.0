...
JavaScript-compatible Unicode data for use in Node.js. Included: arrays of code points, arrays of symbols, and regular expressions for Unicode v4.0.0’s categories, scripts, blocks, and properties, as well as bidi mirroring and case folding data.
...
```bash
npm install unicode-4.0.0 --save
```
...
var codePoints = require('unicode-4.0.0/categories/Lu/code-points');
// Get an array of symbols (strings) in a given Unicode category:
var symbols = require('unicode-4.0.0/categories/Lu/symbols');
// Get a regular expression that matches any symbol in a given Unicode category:
var regex = require('unicode-4.0.0/categories/Lu/regex');
// Get the canonical category a given code point belongs to:
// (Note: U+0041 is LATIN CAPITAL LETTER A)
var category = require('unicode-4.0.0/categories')[ 0x41 ];
// Get an array of all code points with the `Bidi_ON` bidi property:
var on = require('unicode-4.0.0/bidi/ON/code-points');
// Get the directionality of a given code point:
var directionality = require('unicode-4.0.0/bidi')[ 0x41 ];

// …you get the idea.
```

Other than categories, data on Unicode properties, blocks, and scripts is available too (for recent versions of the Unicode standard). Here’s the full list of the available data for v4.0.0:
...
require('unicode-4.0.0/categories')[ codePoint ]; // lookup array
...
require('unicode-4.0.0/bidi')[ codePoint ]; // lookup array

require('unicode-4.0.0/bidi/BN/code-points');
require('unicode-4.0.0/bidi/BN/symbols');
require('unicode-4.0.0/bidi/BN/regex');

require('unicode-4.0.0/bidi/S/code-points');
require('unicode-4.0.0/bidi/S/symbols');
require('unicode-4.0.0/bidi/S/regex');

require('unicode-4.0.0/bidi/B/code-points');
require('unicode-4.0.0/bidi/B/symbols');
require('unicode-4.0.0/bidi/B/regex');

require('unicode-4.0.0/bidi/WS/code-points');
require('unicode-4.0.0/bidi/WS/symbols');
require('unicode-4.0.0/bidi/WS/regex');

require('unicode-4.0.0/bidi/ON/code-points');
require('unicode-4.0.0/bidi/ON/symbols');
require('unicode-4.0.0/bidi/ON/regex');

require('unicode-4.0.0/bidi/ET/code-points');
require('unicode-4.0.0/bidi/ET/symbols');
require('unicode-4.0.0/bidi/ET/regex');

require('unicode-4.0.0/bidi/CS/code-points');
require('unicode-4.0.0/bidi/CS/symbols');
require('unicode-4.0.0/bidi/CS/regex');

require('unicode-4.0.0/bidi/ES/code-points');
require('unicode-4.0.0/bidi/ES/symbols');
require('unicode-4.0.0/bidi/ES/regex');

require('unicode-4.0.0/bidi/EN/code-points');
require('unicode-4.0.0/bidi/EN/symbols');
require('unicode-4.0.0/bidi/EN/regex');

require('unicode-4.0.0/bidi/L/code-points');
require('unicode-4.0.0/bidi/L/symbols');
require('unicode-4.0.0/bidi/L/regex');

require('unicode-4.0.0/bidi/NSM/code-points');
require('unicode-4.0.0/bidi/NSM/symbols');
require('unicode-4.0.0/bidi/NSM/regex');

require('unicode-4.0.0/bidi/R/code-points');
require('unicode-4.0.0/bidi/R/symbols');
require('unicode-4.0.0/bidi/R/regex');

require('unicode-4.0.0/bidi/AL/code-points');
require('unicode-4.0.0/bidi/AL/symbols');
require('unicode-4.0.0/bidi/AL/regex');

require('unicode-4.0.0/bidi/AN/code-points');
require('unicode-4.0.0/bidi/AN/symbols');
require('unicode-4.0.0/bidi/AN/regex');

require('unicode-4.0.0/bidi/LRE/code-points');
require('unicode-4.0.0/bidi/LRE/symbols');
require('unicode-4.0.0/bidi/LRE/regex');

require('unicode-4.0.0/bidi/RLE/code-points');
require('unicode-4.0.0/bidi/RLE/symbols');
require('unicode-4.0.0/bidi/RLE/regex');

require('unicode-4.0.0/bidi/PDF/code-points');
require('unicode-4.0.0/bidi/PDF/symbols');
require('unicode-4.0.0/bidi/PDF/regex');

require('unicode-4.0.0/bidi/LRO/code-points');
require('unicode-4.0.0/bidi/LRO/symbols');
require('unicode-4.0.0/bidi/LRO/regex');

require('unicode-4.0.0/bidi/RLO/code-points');
require('unicode-4.0.0/bidi/RLO/symbols');
require('unicode-4.0.0/bidi/RLO/regex');
...
require('unicode-4.0.0/case-folding/C/code-points'); // lookup table with code point to code point mappings
require('unicode-4.0.0/case-folding/C/code-points')[ codePoint ]; // lookup table
require('unicode-4.0.0/case-folding/C/symbols'); // lookup table with symbol to symbol mappings
require('unicode-4.0.0/case-folding/C/symbols')[ symbol ]; // lookup table

require('unicode-4.0.0/case-folding/T/code-points'); // lookup table with code point to code point mappings
require('unicode-4.0.0/case-folding/T/code-points')[ codePoint ]; // lookup table
require('unicode-4.0.0/case-folding/T/symbols'); // lookup table with symbol to symbol mappings
require('unicode-4.0.0/case-folding/T/symbols')[ symbol ]; // lookup table

require('unicode-4.0.0/case-folding/F/code-points'); // lookup table with code point to code point mappings
require('unicode-4.0.0/case-folding/F/code-points')[ codePoint ]; // lookup table
require('unicode-4.0.0/case-folding/F/symbols'); // lookup table with symbol to symbol mappings
require('unicode-4.0.0/case-folding/F/symbols')[ symbol ]; // lookup table

require('unicode-4.0.0/case-folding/S/code-points'); // lookup table with code point to code point mappings
require('unicode-4.0.0/case-folding/S/code-points')[ codePoint ]; // lookup table
require('unicode-4.0.0/case-folding/S/symbols'); // lookup table with symbol to symbol mappings
require('unicode-4.0.0/case-folding/S/symbols')[ symbol ]; // lookup table
